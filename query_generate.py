...
class QueryGenerate(QueryProcessor):
    ...
    def process(self, context: QueryContext) -> None:
        """
            List[str] -> List[str], Dict[str, document]:

            处理QueryContext，使用切割好的 chunk 生成问题和问题到chunk的映射。
    ...
    def generate_query(self, documents) -> tuple:
        ...
        """
        questions = []  # 初始化问题列表，List[str]
        question_to_doc_mapping = {}  # 初始化问题到文档的映射，Dict[str, document]
